      ...
      <div class="table-responsive">
        <table class="table align-items-center table-flush">
          <thead class="thead-light">
            <tr>
              <th scope="col" class="sort" data-sort="name">Nama Ruangan</th>
              <th scope="col" class="sort" data-sort="capacity">Kapasitas</th>
              <th scope="col"></th>
            </tr>
          </thead>
          <tbody class="list">
            ...
            ?>
              <tr>
                ...
                <td class="text-right">
                  ...
                  <button type="button" class="btn btn-outline-danger" data-id="<?= $room->id ?>" data-toggle="modal" data-target="#deletionModal">
                    Hapus
                  </button>
                </td>
              </tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deletionModalLabel">Hapus Ruangan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Apakah anda yakin ingin menghapus ruangan ini? Ruangan akan dihapus secara permanen dan tidak dapat kembali
      </div>
